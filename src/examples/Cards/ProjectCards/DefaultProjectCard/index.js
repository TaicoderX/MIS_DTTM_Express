...
function DefaultProjectCard({ image, label, title, description, action, authors, distance, isWorking, percent, status }) {
      ...
      >
        ...
        <VuiBox display="flex" justifyContent="space-between" alignItems="center">
          <VuiButton
            ...
            size="small"
            color='success'
            sx={{ flexGrow: 1, marginRight: 1 }} // Đảm bảo mỗi button chiếm cùng một không gian
          >
            {action.label}
          </VuiButton>
          ...
          <VuiButton
            ...
            size="small"
            color='info'
            sx={{ flexGrow: 1, marginLeft: 1 }} // Đảm bảo mỗi button chiếm cùng một không gian
          >
            {action.label2}
          </VuiButton>
        </VuiBox>
